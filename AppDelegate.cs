...
namespace OZ_WINE_APP
{
	...
	public class AppDelegate : UIApplicationDelegate, IUISplitViewControllerDelegate
	{
		...
		public override bool FinishedLaunching (UIApplication application, NSDictionary launchOptions)
		{
			...
			//var navigationController = (UINavigationController)ViewController.ViewControllers [1];
			//var TabBarController = (UITabBarController)Window.RootViewController;		//Issue is here
			//var navigationController = (UINavigationController)TabBarController.ViewControllers [1];
			//navigationController.TopViewController.NavigationItem.LeftBarButtonItem = TabBarController.SearchDisplayController;
			//TabBarController.WeakDelegate = this;

			//Window = new UIWindow (UIScreen.MainScreen.Bounds);
			//Window.RootViewController = new CustomTabBarController ();
			//Window.MakeKeyAndVisible ();



			//loginViewController = new LoginViewController (this.Window.RootViewController as LoginViewController);
